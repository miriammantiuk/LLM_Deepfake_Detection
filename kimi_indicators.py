...
thinking_type = "enabled"  # "enabled" reasoning, "disabled" für kein reasoning
suffix = "_thinking" if thinking_type == "enabled" else ""

# =========================
# Pfade
# =========================
video_ordner = Path(r"C:\Users\miria\Deepfake_Detection\data\processed")
output_datei = Path(rf"C:\Users\miria\Deepfake_Detection\{model}{suffix}_indicators.json")
