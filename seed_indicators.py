...
# =========================
# Stelle sicher, dass du OPENROUTER_API_KEY in deinen Umgebungsvariablen hast
...
thinking = True # True reasoning, False für kein reasoning
suffix = "_thinking" if thinking == True else ""

# =========================
# Pfade
# =========================
video_ordner = Path(r"C:\Users\miria\Deepfake_Detection\data\processed")
output_datei = Path(rf"C:\Users\miria\Deepfake_Detection\seed-2.0-lite{suffix}_indicators.json")
